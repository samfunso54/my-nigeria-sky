...
import { CloudSun, Shield, Bell, Globe } from 'lucide-react';

const lagosWeather = getMockWeather('Lagos', 'Lagos');
const abujaWeather = getMockWeather('Abuja', 'FCT');
          ...
          {showAuth ? (
            ...
            >
              ...
              <button
                ...
                className="block mx-auto mt-4 text-sm text-primary-foreground/60 hover:text-primary-foreground"
              >
                ← Back to weather
              </button>
            </motion.div>
